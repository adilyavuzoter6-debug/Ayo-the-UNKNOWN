...
export enum Permission {
  ...
  FISH_SPECIES_UPDATE = "fish_species:update",
  ...
  COST_ENTRY_CREATE = "cost_entry:create",
  COST_ENTRY_READ = "cost_entry:read",
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  COMPANY_OWNER: [
    ...
    Permission.FISH_SPECIES_UPDATE,
